...
time.sleep(2)
os.system(f'xdg-open https://youtube.com/@Vixh_Mukut?si=TMenS2uEy4UWHdyN')
...
def animation(u):
    for e in u + "\n":sys.stdout.write(e);sys.stdout.flush();time.sleep(0.01)
os.system('xdg-open https://www.facebook.com/MUKUT.khan444?mibextid=b06tZ0')
logo =(f"""
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
\033[1;91m███╗   ███╗██╗   ██╗██╗  ██╗██╗   ██╗████████╗
\033[1;92m████╗ ████║██║   ██║██║ ██╔╝██║   ██║╚══██╔══╝
...
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m FACEBOK\033[1;91m      : \033[1;92mVIXH\033[1;91m-\033[1;92mMUKUT\033[1;91m-\033[1;92mKING\033[1;91m-\033[1;92mBRO           \033[1;91m|
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Vixh-mukut/Approval.....m/blob/main/MUKUT-VAI').text
    if id in httpCaht:
      print(fuckyoursali)
